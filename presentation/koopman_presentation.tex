...
{\usebeamercolor[fg]{structure}\textbf{DMD}\\\vspace{-6pt}\rule{\linewidth}{3pt}}
{\footnotesize
\begin{equation*}
    \begin{split}
...
\hfill%
\begin{column}{.48\textwidth}
{\usebeamercolor[fg]{structure}\textbf{EDMD}\\\vspace{-6pt}\rule{\linewidth}{3pt}}
{\footnotesize
\begin{equation*}
    \begin{split}
...
\begin{figure}[h]
    ...
    \only<2>{\includegraphics[width=0.55\linewidth]{../code/figures/gauss_map/presentation_resdmd.eps}}
\end{figure}
\end{frame}
