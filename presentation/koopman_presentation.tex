...
\makebox[\textwidth][c]{
    \begin{subfigure}{0.45\textwidth}
        ...
        \caption{ResDMD starting from a hand-crafted dictionary (the first $K = 40$) Legendre polynomials.}
    \end{subfigure}\hspace*{\fill}
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\linewidth]{../code/figures/gauss_map/kernelized/KEDMD_2step_rbf_Montecarlo.eps}
        \caption{Kernelized ResDMD starting from the RBF kernel.}
